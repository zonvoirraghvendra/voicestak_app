...
return array(
    'CallFire\\Api\\ClientTest' => $baseDir . '/tests/Api/ClientTest.php',
    'CallFire\\Api\\Rest\\AbstractIntegrationTest' => $baseDir . '/tests/Integration/Rest/AbstractIntegrationTest.php',
    'CallFire\\Api\\Rest\\BroadcastTest' => $baseDir . '/tests/Integration/Rest/BroadcastTest.php',
    'CallFire\\Api\\Rest\\ClientTest' => $baseDir . '/tests/Api/Rest/AbstractClientTest.php',
    'CallFire\\Api\\Rest\\Request\\MockRequest' => $baseDir . '/tests/Api/Rest/Request/MockRequest.php',
    'CallFire\\Api\\Rest\\Request\\RequestTest' => $baseDir . '/tests/Api/Rest/RequestTest.php',
    'CallFire\\Api\\Rest\\Response\\ResourceListTest' => $baseDir . '/tests/Api/Rest/Response/ResourceListTest.php',
    'CallFire\\Api\\Rest\\Response\\ResourceReferenceTest' => $baseDir . '/tests/Api/Rest/Response/ResourceReferenceTest.php',
    'CallFire\\Api\\Rest\\Response\\ResponseTest' => $baseDir . '/tests/Api/Rest/ResponseTest.php',
    'CallFire\\Api\\Soap\\AbstractClientTest' => $baseDir . '/tests/Api/Soap/AbstractClientTest.php',
    'CallFire\\Api\\Soap\\AbstractIntegrationTest' => $baseDir . '/tests/Integration/Soap/AbstractIntegrationTest.php',
    'CallFire\\Api\\Soap\\AbstractRequestTest' => $baseDir . '/tests/Api/Soap/AbstractRequestTest.php',
    'CallFire\\Api\\Soap\\AbstractResultTest' => $baseDir . '/tests/Api/Soap/AbstractResultTest.php',
    'CallFire\\Api\\Soap\\BroadcastTest' => $baseDir . '/tests/Integration/Soap/BroadcastTest.php',
    'CallFire\\Api\\Soap\\CallTest' => $baseDir . '/tests/Integration/Soap/CallTest.php',
    'CallFire\\Api\\Soap\\ContactTest' => $baseDir . '/tests/Integration/Soap/ContactTest.php',
    'CallFire\\Api\\Soap\\LabelTest' => $baseDir . '/tests/Integration/Soap/LabelTest.php',
    'CallFire\\Api\\Soap\\NumberTest' => $baseDir . '/tests/Integration/Soap/NumberTest.php',
    'CallFire\\Api\\Soap\\SubscriptionTest' => $baseDir . '/tests/Integration/Soap/SubscriptionTest.php',
    'CallFire\\Api\\Soap\\TextTest' => $baseDir . '/tests/Integration/Soap/TextTest.php',
    'CallFire\\CodeExampleLintTest' => $baseDir . '/tests/Docs/CodeExampleLintTest.php',
    'CallFire\\Common\\IvrTest' => $baseDir . '/tests/Ivr/IvrTest.php',
    'CallFire\\Common\\Ivr\\DialplanTest' => $baseDir . '/tests/Ivr/Ivr/DialplanTest.php',
    'CallFire\\Common\\Ivr\\Dialplan\\AbstractTagTest' => $baseDir . '/tests/Ivr/Ivr/Dialplan/AbstractTagTest.php',
    'CallFire\\Common\\Resource\\AbstractResourceTest' => $baseDir . '/tests/Common/Resource/AbstractResourceTest.php',
    'CallFire\\Common\\SubscriptionTest' => $baseDir . '/tests/Common/SubscriptionTest.php',
    'CallFire\\Common\\Subscription\\TextNotificationTest' => $baseDir . '/tests/Common/Subscription/TextNotificationTest.php',
    ...
    'SebastianBergmann\\Diff' => $vendorDir . '/sebastian/diff/src/Diff.php',
