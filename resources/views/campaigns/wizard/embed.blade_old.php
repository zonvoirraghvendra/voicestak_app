                            ...
                            @endif
                                <div class='option-row'>
                                    ...
                                    <div class='option-row-content'>
                                        ...
                                        @if(isset($widget) && $widget->custom_button_code != '')
                                        {!! Form::textarea('embed_code', '<link rel="stylesheet" href="//'.$_SERVER['SERVER_NAME'].'/assets/css/voice-stack.css"><div class="vs-frontend-button-container"><div id="vs_custom_button_code">'.$widget->custom_button_code.'</div><a class="frontend-widget-preview" href="#widget-preview">&nbsp;</a></div><iframe id="widget-preview" src="//'.$_SERVER['SERVER_NAME'].'/widgets/popup-widget-preview/'.$widget->token_field.'" class="widgets-iframe not-show" style="visibility: visible; width: 460px;"></iframe><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/fancybox.js"></script><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/voice-stack.js"></script><link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="//'.$_SERVER['SERVER_NAME'].'/assets/css/ios_styles.css" rel="stylesheet" type="text/css" /><div class="modal fade" id="popup-ios" role="dialog" tabindex="-1"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button><h3 class="modal-title">There\'s A VoiceStak App for iOS!</h3></div><div class="modal-body"><a href="Voicestak://?token='.$widget->token_field.'&first_name_field_active='.$widget->first_name_field_active.'&first_name_field_required='.$widget->first_name_field_required.'&email_field_required='.$widget->email_field_required.'&phone_field_active='.$widget->phone_field_active.'&phone_field_required='.$widget->phone_field_required.'" id="launch_voicestak_button"><button type="button" class="btn btn-primary">I Have The App</button></a><a href="http://itunes.com/apps/voicestak"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/12003484042/original/app-store-icon.png?1459527095"></a><p class="note"><b>NOTE:</b>After you have installed the app, return to this page and tap on the launch button.</p></div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal" type="button">Close</button></div></div></div></div><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/bootstrap_plugins.js">' , [ 'id' => 'embed-modal' , 'class' => 'embed_code form-control no-resize', 'rows' => 8 ]) !!}
                                        @else
                                            @if(isset($widget) && $widget->tab_design && $widget->type == 'side-lock' )
                                                @if($widget->lightbox  == 1)
                                                    {!! Form::textarea('embed_code', '<link rel="stylesheet" href="//'.$_SERVER['SERVER_NAME'].'/assets/css/voice-stack.css"><div class="frontend-tab-container-side"><iframe id="ifrm" src="//'.$_SERVER['SERVER_NAME'].'/widgets/side-widget/'.$widget->token_field.'" class="tabs-iframe front-tabs-iframe"></iframe><a class="frontend-widget-preview" href="#widget-preview">&nbsp;</a></div><iframe id="widget-preview" src="//'.$_SERVER['SERVER_NAME'].'/widgets/popup-widget-preview/'.$widget->token_field.'" class="widgets-iframe not-show" style="visibility: visible; width: 460px;"></iframe><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/fancybox.js"></script><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/voice-stack.js"></script><link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="//'.$_SERVER['SERVER_NAME'].'/assets/css/ios_styles.css" rel="stylesheet" type="text/css" /><div class="modal fade" id="popup-ios" role="dialog" tabindex="-1"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button><h3 class="modal-title">There\'s A VoiceStak App for iOS!</h3></div><div class="modal-body"><a href="Voicestak://?token='.$widget->token_field.'&first_name_field_active='.$widget->first_name_field_active.'&first_name_field_required='.$widget->first_name_field_required.'&email_field_required='.$widget->email_field_required.'&phone_field_active='.$widget->phone_field_active.'&phone_field_required='.$widget->phone_field_required.'" id="launch_voicestak_button"><button type="button" class="btn btn-primary">I Have The App</button></a><a href="http://itunes.com/apps/voicestak"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/12003484042/original/app-store-icon.png?1459527095"></a><p class="note"><b>NOTE:</b>After you have installed the app, return to this page and tap on the launch button.</p></div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal" type="button">Close</button></div></div></div></div><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/bootstrap_plugins.js">' , [ 'id' => 'embed-modal' , 'class' => 'embed_code form-control no-resize', 'rows' => 8 ]) !!}
                                                @else
                                                    {!! Form::textarea('embed_code', '<script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/jquery.slidein.js"></script><div class="slide-out-div slide-out-div-new"><div class="frontend-tab-container-side handle"><iframe id="ifrm" src="//'.$_SERVER['SERVER_NAME'].'/widgets/side-widget/'.$widget->token_field.'" class="tabs-iframe front-tabs-iframe" style="visibility: hidden;" onload="VoiceStackIframe(this.id)"></iframe><a class="frontend-widget-preview">&nbsp;</a></div><iframe id="widget-preview" src="//'.$_SERVER['SERVER_NAME'].'/widgets/popup-widget-preview/'.$widget->token_field.'" class="widgets-iframe not-show" style="visibility: hidden; width: 460px;"  onload="VoiceStackIframe(this.id)"></iframe></div><link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="//'.$_SERVER['SERVER_NAME'].'/assets/css/ios_styles.css" rel="stylesheet" type="text/css" /><div class="modal fade" id="popup-ios" role="dialog" tabindex="-1"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button><h3 class="modal-title">There\'s A VoiceStak App for iOS!</h3></div><div class="modal-body"><a href="Voicestak://?token='.$widget->token_field.'&first_name_field_active='.$widget->first_name_field_active.'&first_name_field_required='.$widget->first_name_field_required.'&email_field_required='.$widget->email_field_required.'&phone_field_active='.$widget->phone_field_active.'&phone_field_required='.$widget->phone_field_required.'" id="launch_voicestak_button"><button type="button" class="btn btn-primary">I Have The App</button></a><a href="http://itunes.com/apps/voicestak"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/12003484042/original/app-store-icon.png?1459527095"></a><p class="note"><b>NOTE:</b>After you have installed the app, return to this page and tap on the launch button.</p></div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal" type="button">Close</button></div></div></div></div><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/bootstrap_plugins.js">' , [ 'id' => 'embed-modal' , 'class' => 'embed_code form-control no-resize', 'rows' => 8 ]) !!}
                                                @endif
                                            @elseif(isset($widget) && $widget->tab_design != '' && $widget->type == 'footer-lock' )
                                                @if($widget->lightbox  == 1)
                                                    {!! Form::textarea('embed_code', '<link rel="stylesheet" href="//'.$_SERVER['SERVER_NAME'].'/assets/css/voice-stack.css"><div class="frontend-tab-container"><iframe id="ifrm" src="//'.$_SERVER['SERVER_NAME'].'/widgets/footer-widget/'.$widget->token_field .'" class="tabs-iframe front-tabs-iframe"></iframe><a class="frontend-widget-preview" href="#widget-preview">&nbsp;</a></div><iframe id="widget-preview" src="//'.$_SERVER['SERVER_NAME'].'/widgets/popup-widget-preview/'.$widget->token_field.'" class="widgets-iframe not-show" style="visibility: visible; width: 460px;"></iframe><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/fancybox.js"></script><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/voice-stack.js"></script><link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="//'.$_SERVER['SERVER_NAME'].'/assets/css/ios_styles.css" rel="stylesheet" type="text/css" /><div class="modal fade" id="popup-ios" role="dialog" tabindex="-1"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button><h3 class="modal-title">There\'s A VoiceStak App for iOS!</h3></div><div class="modal-body"><a href="Voicestak://?token='.$widget->token_field.'&first_name_field_active='.$widget->first_name_field_active.'&first_name_field_required='.$widget->first_name_field_required.'&email_field_required='.$widget->email_field_required.'&phone_field_active='.$widget->phone_field_active.'&phone_field_required='.$widget->phone_field_required.'" id="launch_voicestak_button"><button type="button" class="btn btn-primary">I Have The App</button></a><a href="http://itunes.com/apps/voicestak"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/12003484042/original/app-store-icon.png?1459527095"></a><p class="note"><b>NOTE:</b>After you have installed the app, return to this page and tap on the launch button.</p></div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal" type="button">Close</button></div></div></div></div><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/bootstrap_plugins.js">' , [ 'id' => 'embed-modal' , 'class' => 'embed_code form-control no-resize', 'rows' => 8 ]) !!}
                                                @else
                                                    {!! Form::textarea('embed_code', '<script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/jquery.slidein.js"></script><div class="slide-out-div slide-out-div-new"><div class="frontend-tab-container-side handle"><iframe id="ifrm" src="//'.$_SERVER['SERVER_NAME'].'/widgets/footer-widget/'.$widget->token_field.'" class="tabs-iframe front-tabs-iframe" style="visibility: hidden;" onload="VoiceStackIframe(this.id)"></iframe><a class="frontend-widget-preview">&nbsp;</a></div><iframe id="widget-preview" src="//'.$_SERVER['SERVER_NAME'].'/widgets/popup-widget-preview/'.$widget->token_field.'" class="widgets-iframe not-show" style="visibility: hidden; width: 460px;" onload="VoiceStackIframe(this.id)"></iframe></div><link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link href="//'.$_SERVER['SERVER_NAME'].'/assets/css/ios_styles.css" rel="stylesheet" type="text/css" /><div class="modal fade" id="popup-ios" role="dialog" tabindex="-1"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button><h3 class="modal-title">There\'s A VoiceStak App for iOS!</h3></div><div class="modal-body"><a href="Voicestak://?token='.$widget->token_field.'&first_name_field_active='.$widget->first_name_field_active.'&first_name_field_required='.$widget->first_name_field_required.'&email_field_required='.$widget->email_field_required.'&phone_field_active='.$widget->phone_field_active.'&phone_field_required='.$widget->phone_field_required.'" id="launch_voicestak_button"><button type="button" class="btn btn-primary">I Have The App</button></a><a href="http://itunes.com/apps/voicestak"><img src="https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/12003484042/original/app-store-icon.png?1459527095"></a><p class="note"><b>NOTE:</b>After you have installed the app, return to this page and tap on the launch button.</p></div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal" type="button">Close</button></div></div></div></div><script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].'/assets/js/bootstrap_plugins.js">' , [ 'id' => 'embed-modal' , 'class' => 'embed_code form-control no-resize', 'rows' => 8 ]) !!}
                                                @endif
                                            @endif
                                        @endif
