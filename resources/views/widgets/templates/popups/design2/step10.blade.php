        ...
        <section class="popup popup-five popup16">
            ...
            <div>
                <h4 id="done-processing-heading">
                    @if(isset($widget) && isset($widget->eight) && $widget->eight != '')
                    {!! $widget->eight !!}
                    @else
                    Your video is processing, it may take up to 60 seconds to load preview
                    @endif
                </h4>
            </div>
            <div>
            ...
            <div class="btn-holder" style="display: none !important;">
                ...
                <form method="post" enctype="multipart/form-data" id="video_data_form">
                    ...
                    @else        
                    <a href="javascript:void(0)" class="btn-send dsgn1bs10 send_video_message" id="send-video" @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>
