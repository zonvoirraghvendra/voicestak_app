                    ...
                    <div class="popup-frame">
                        <fieldset>
                            ...
                            <div class="btn-holder">
                                ...
                                <button type="submit" class="btn-send" id="validate_inputs"><span @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>
                                ...
                                <button type="button" class="btn-send voice-send-phone" id="validate_inputs"><span @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>
                                    @if(isset($widget) && isset($widget->five3) && $widget->five3 != '')
                                    {!! $widget->five3 !!}
                                    @else
                                    Send
