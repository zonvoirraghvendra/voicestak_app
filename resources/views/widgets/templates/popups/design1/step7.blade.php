<div style="display: none;" class="display_div d1 step_7">
    ...
    @else
    <a href="javascript:void(0);" class="btn-popup videoFlash" @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>
     @if(isset($widget) && isset($widget->six3) && $widget->six3 != '')
     {!! $widget->six3 !!}
     @else
     Start Recording
