                           ...
                           <div class="popup-frame">
                            <fieldset>
                                ...
                                <p @if(isset($widget)) style="color: {!! $widget->widget_text_color !!}" @endif>
                                    ...
                                    {!! $widget->five2 !!}
                                    @else
                                    By sending this message, I give permission to view, reply to,<br> download and share my message</p>
                                    @endif
                                </p>
                                <div class="btn-holder">
                                    ...
                                    {{--<button type="submit" class="btn-send" id="validate_inputs_video" @if(isset($widget)) style="background: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif><span>
                                    ...
                                    {{--<button type="button" class="btn-send video-send-phone" id="validate_inputs_video" @if(isset($widget)) style="background: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif><span>
                                        @if(isset($widget) && isset($widget->five3) && $widget->five3 != '')
                                        {!! $widget->five3 !!}
                                        @else
                                        Send
                                    ...
                                    {{--@endif--}}
                                    <a href="javascript:void(0)" class="btn-send dsgn1s11 send_video_message" id="send-video" @if(isset($widget)) style="background-color: {!! $widget->widget_buttons_bg_color !!} ; color: {!! $widget->widget_buttons_text_color !!} !important;" @endif>
                                        @if(isset($widget) && isset($widget->five3) && $widget->five3 != '')
                                        {!! $widget->five3 !!}
                                        @else
                                        Send
