    ...
    <div class="col-md-12 col-sm-12 col-xs-12 choose-widget-design" id="side-lock-ajax">
        ...
        <div class="side-lock-item">
            <label class="view-steps-img">
                ...
                @endif
                @if($i != 10)
                <div class="view-steps-img-container" style="background: url('/assets/img/tabs-2/voice/{!! $i !!}.png') right top no-repeat; background-size: auto 100%;"></div>
                @else
                <div class="view-steps-img-container" style="background: url('/assets/img/tabs-2/voice/{!! $i !!}.png') right top no-repeat; background-size: 100% auto;"></div>
                @endif
