...
function sendAudio() {
	$.ajax({
		type    	: 'POST',
		url     	: 'http://app.voicestak.com:4444/only-audio',
		...
		success 	: function(data){
			if(audio_count < audio_bytes.length) {
				...
				$.post("http://app.voicestak.com:4444/only-audio-complete", {token:token, flashAudio:audio_final_value, finish: true}, function(data){
